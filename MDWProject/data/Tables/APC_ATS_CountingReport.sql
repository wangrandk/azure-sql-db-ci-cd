CREATE TABLE [data].[APC_ATS_CountingReport] (
    ...
    CONSTRAINT [PK_APC_ATS_CountingReport] PRIMARY KEY CLUSTERED ([CountingReportRef] ASC)
);


GO

CREATE NONCLUSTERED INDEX [IX_APC_ATS_CountingReport_AlightingJourneyPointRef_DateTime]
    ON [data].[APC_ATS_CountingReport]([AlightingJourneyPointRef] ASC, [DateTime] ASC);


GO

CREATE NONCLUSTERED INDEX [IX_APC_ATS_CountingReport_BoardingJourneyPointRef_DateTime]
    ON [data].[APC_ATS_CountingReport]([BoardingJourneyPointRef] ASC, [DateTime] ASC);
